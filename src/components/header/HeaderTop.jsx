...
import { selectSumCountity } from "../../redux/features/Products/productSlice";
      ...
      <div className="flex md:justify-end justify-between items-center gap-2 lg:col-span-2 md:col-span-3 col-span-5">
        ...
        <div className="flex items-center gap-5">
          ...
          <div className="relative">
            ...
            <span className="size-4 absolute top-4 right-0 flex justify-center items-center text-base pt-1 bg-primaryColor text-white rounded-full">{countProducts == 0 ? "0" : countProducts} </span>
          </div>
        </div>
      </div>
    </div>
