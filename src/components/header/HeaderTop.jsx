      ...
      <div className="flex md:justify-end justify-between items-center gap-2 lg:col-span-2 md:col-span-3 col-span-5">
        ...
        <div className="flex items-center gap-5">
          ...
          <div className="relative">
            ...
            <div className={`w-96 ${selectQuantity == 0 ? 'h-60' : 'h-80'} overflow-y-auto .scrollbar-thumb scrollbar-track scrollbar ${open ? 'visible' : 'hidden'} absolute top-18 left-0 z-[10000] rounded-xl text-black dark:bg-black dark:text-white`}>
              {selectQuantity == 0 ?
