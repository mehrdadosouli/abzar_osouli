...
export default function HeaderMain({ setGetTheme, getTheme }) {
  ...
  return (
    <div className="grid grid-cols-4 items-center md:px-24 md:py-3 bg-box_lighten_secondry sticky top-0 z-50">
      ...
      <div className={`h-fit absolute left-8 top-0 bottom-0 my-auto  ${width <= '1102' ? "flex" : "hidden" }`}> 
          <li className="bg-transparent hover:cursor-pointer list-none" onClick={clickHandler}>
            <HamburgerSvg />
          </li>
      </div>
