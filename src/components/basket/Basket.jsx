...
function Basket({setGetTheme, getTheme }) {
    ...
    return (<div className="relative w-fit z-[10000]">
        <svg onClick={shopHandler} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="black" className="size-20 p-7 select-none dark:text-white cursor-pointer">
